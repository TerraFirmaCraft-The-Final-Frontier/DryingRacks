...
public class BlockRackMetal extends Block implements ITileEntityProvider, IItemSize
{
    private static final Map<Metal, BlockRackMetal> MAP = new HashMap<>();

    public Metal metal;

    public BlockRackMetal(Metal metal)
    {
    ...
    {
        return new TileEntityRackMetal();
    }
}